  ...
  <head>
    ...
    <!-- /* Pop up / alert Box / Model box  */ -->
      ...
      <div id="multiSelectCdn">
        ...
        rel="stylesheet"
        type="text/css"
        href="wp-content/themes/irl-theme/bootstrap.css"
        />
        <link
        rel="stylesheet"
        type="text/css"
        href="wp-content/themes/irl-theme/bootstrap-select.min.css"
        />
        <script
        type="text/javascript"
        src="wp-content/themes/irl-theme/bootstrap.bundle.js"
        ></script>
        <script
        type="text/javascript"
        src="wp-content/themes/irl-theme/bootstrap-select.min.js"
        ></script>
      </div>
      <link rel="stylesheet" href="wp-content/themes/irl-theme/style.css" />
    <div id="mad">    
      ...
      <div class="front-page">
       <!-- validation section with qr code  -->
        ...
        <div class="section cover-page">
          ...
          <img src="wp-content/themes/irl-theme/img/background.jpg" style="box-sizing: initial;height: 12.6cm;margin-top: -1px;"/>
          
          <!-- IRL logo portion -->
          <center style="background: url(wp-content/themes/irl-theme/img/Irl-logo-bg.jpg); background-position: center; background-size: contain; }">
...
">Ref. no: </span> </div>
          ...
          <div class="product">
            ...
            <img class="tick" src="wp-content/themes/irl-theme/img/tick.png" width="20" alt="" />
        ...
        <div class="sec-page section">
          ...
          <div style="font-size:9px; font-family:brela">
            ...
            <div class="irl-note" style="width:60%; position:absolute; bottom:0cm; right:0.2cm;"><span class="red">Note:</span> All compartments might not be visible to the naked eye on digital x-ray images due to Technical limitations</div>
          </div>
...
<div id="mad2" >
 ...
 <page class="Nepa_page Nepa_Container">
    ...
    <div class="Nepa_section1 Nepa_common">
        <span class="Nepa_form-text">Date:</span>
     ...
     <div class="Nepa_section2 Nepa_common">
     <span class="Nepa_section2_common"> <?php echo $nepa;?></span>
        <span class="Nepa_section2_common"></span>
        <span class="Nepa_section2_common">20302136100223</span>
        <span class="Nepa_section2_common">Nepali Rudraksha</span>
        <span class="Nepa_section2_common">Silver</span>
        <span class="Nepa_extra2"> 2 mukhi medium</span>
        <span class="Nepa_section2_common">18.68 mm</span>
        <span class="Nepa_section2_common">1.8 gms</span>
        <span class="Nepa_section2_common">Redish Brown | well Ripen -2 natural compartment.</span>
    </div>
                      ...
                      div#output${count} {
                        ...
                        const displayNum = (value) => {
                            ...
                            if (values.length == 1) {
                                ...
                                if (values.length == 2) {
                                    parent.style.left = value / 0.9 + 30 + '%'
                          ...
                          <div class="product-image">
                            ...
                            <label for="${id}Input" style="cursor: pointer; position: relative; display:flex; font-size:10px!important; justify-content: center; ">
                              <div class="moveable-jaw" style="display:flex; width:auto; ">
                                  ...
                                  ${value=="Japa Mala" 
                                    ? `<img id="weight${count}" style="left: 0%;" src="wp-content/themes/irl-theme/" /><span class="upload-msg" id="upload-msg${count}" style="z-index: 1; width: max-content"> Upload Image</span><img id="rud${count}" class="japa-weight" src style=" position: absolute; height: 100%!important; min-height:auto;"/>` 
                                    : `<img id="weight${count}" style="left: 0%;" src="wp-content/themes/irl-theme/weight/weight.png" /><img id="rud${count}" class="rudrakshaWeight" src style=" position: absolute; height: auto; min-height:auto;"/><div id="output${count}" style="position: absolute; left: 21px; bottom: 12px;"></div>
