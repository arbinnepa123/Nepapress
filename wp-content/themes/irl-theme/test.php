...
<html>
  <head>
    ...
    <link rel="stylesheet" href="https://demo.rudrakshalab.com/wp-content/themes/irl-theme/style.css" />
    <script src="https://demo.rudrakshalab.com/wp-content/themes/irl-theme/html2pdf.js"></script>
    <script src="https://demo.rudrakshalab.com/wp-content/themes/irl-theme/loadimages.js"></script>
    <script>
    ...
    <!-- /* Pop up / alert Box / Model box  */ -->
      ...
      <div id="multiSelectCdn">
        ...
        rel="stylesheet"
        type="text/css"
        href="https://demo.rudrakshalab.com/wp-content/themes/irl-theme/bootstrap.css"
        />
        <link
        rel="stylesheet"
        type="text/css"
        href="https://demo.rudrakshalab.com/wp-content/themes/irl-theme/bootstrap-select.min.css"
        />
        <script
        type="text/javascript"
        src="https://demo.rudrakshalab.com/wp-content/themes/irl-theme/bootstrap.bundle.js"
        ></script>
        <script
        type="text/javascript"
        src="https://demo.rudrakshalab.com/wp-content/themes/irl-theme/bootstrap-select.min.js"
        ></script>
      </div>
      <link rel="stylesheet" href="https://demo.rudrakshalab.com/wp-content/themes/irl-theme/style.css" />
    <div id="mad">    
       ...
       <!-- validation section with qr code  -->
        <center class="validation section">
          ...
          <div class="validation-footer">
            <img src="https://demo.rudrakshalab.com/wp-content/themes/irl-theme/img/signature.png" alt="signature" width="75.6" />
        ...
        <div class="section cover-page">
          ...
          <img src="https://demo.rudrakshalab.com/wp-content/themes/irl-theme/img/background.jpg" style="box-sizing: initial;height: 12.6cm;margin-top: -1px;"/>
          
          <!-- IRL logo portion -->
          <center style="background: url(https://demo.rudrakshalab.com/wp-content/themes/irl-theme/img/Irl-logo-bg.jpg); background-position: center; background-size: contain; }">
          <img src="https://demo.rudrakshalab.com/wp-content/themes/irl-theme/img/Irl-logo-bg.jpg" alt="logo " style="width:100%;">  
         </center>
        </div>
      </div>
    </page>
...
">Ref. no: </span> </div>
          ...
          <div class="product">
            ...
            <img class="tick" src="https://demo.rudrakshalab.com/wp-content/themes/irl-theme/img/tick.png" width="20" alt="" />
            ...
            imageTypes.map(
                ...
                <div style="position:relative; ">
                      <div class="product-image caliper-section" >
                        ...
                        <label for="${id}Input" style="cursor: pointer; position: relative; display:flex; font-size:10px!important; justify-content: flex-start; ">
                          <div id="caliper${count}" class="caliper">
                            ...
                            <img id="vernier-scale${count}" src="https://demo.rudrakshalab.com/wp-content/themes/irl-theme/calliper/calliper_head.png" />
                            ...
                            <img id="${id}" class="img-${type} front-caliper-img" style=" position: absolute;left: 15.5%;bottom: 2px;">
                              <img id="jaw${count}" style="left: 0%; " src="https://demo.rudrakshalab.com/wp-content/themes/irl-theme/calliper/jam.png" />
                      ...
                      #main-scale${count} {
                        ...
                        position: absolute;
                        top: 27.2%;
                        background: url(https://demo.rudrakshalab.com/wp-content/themes/irl-theme/calliper/scale1.png);
 ...
 */
                        ...
                        const displayNum = (value) => {
                            ...
                            const convertNumber = (digit) => {
                                ...
                                if (digit[i] === '1') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/calliper/1.png');
                                } else if (digit[i] === '2') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/calliper/2.png');
                                } else if (digit[i] === '3') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/calliper/3.png');
                                } else if (digit[i] === '4') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/calliper/4.png');
                                } else if (digit[i] === '5') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/calliper/5.png');
                                } else if (digit[i] === '6') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/calliper/6.png');
                                } else if (digit[i] === '7') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/calliper/7.png');
                                } else if (digit[i] === '8') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/calliper/8.png');
                                } else if (digit[i] === '9') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/calliper/9.png');
                                } else if (digit[i] === '0') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/calliper/0.png');
                                }
                          ...
                          <div class="product-image">
                            ...
                            <label for="${id}Input" style="cursor: pointer; position: relative; display:flex; font-size:10px!important; justify-content: center; ">
                              <div class="moveable-jaw" style="display:flex; width:auto; ">
                                  ...
                                  ${value=="Japa Mala" 
                                    ? `<img id="weight${count}" style="left: 0%;" src="https://demo.rudrakshalab.com/wp-content/themes/irl-theme/" /><span class="upload-msg" id="upload-msg${count}" style="z-index: 1; width: max-content"> Upload Image</span><img id="rud${count}" class="japa-weight" src style=" position: absolute; height: 100%!important; min-height:auto;"/>` 
                                    : `<img id="weight${count}" style="left: 0%;" src="https://demo.rudrakshalab.com/wp-content/themes/irl-theme/weight/weight.png" /><img id="rud${count}" class="rudrakshaWeight" src style=" position: absolute; height: auto; min-height:auto;"/><div id="output${count}" style="position: absolute; left: 21px; bottom: 12px;"></div>
                      ...
                      `
                        ...
                        const displayNum = (value) => {
                            ...
                            const convertNumber = (digit) => {
                                ...
                                if (digit[i] === '1') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/weight/1.png');
                                } else if (digit[i] === '2') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/weight/2.png');
                                } else if (digit[i] === '3') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/weight/3.png');
                                } else if (digit[i] === '4') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/weight/4.png');
                                } else if (digit[i] === '5') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/weight/5.png');
                                } else if (digit[i] === '6') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/weight/6.png');
                                } else if (digit[i] === '7') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/weight/7.png');
                                } else if (digit[i] === '8') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/weight/8.png');
                                } else if (digit[i] === '9') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/weight/9.png');
                                } else if (digit[i] === '0') {
                                    img.setAttribute('src', 'https://demo.rudrakshalab.com/wp-content/themes/irl-theme/weight/0.png');
                                }
                            }
    ...
    text-align: center;
    flex-wrap: nowrap;
    align-items: flex-start;"><span style="display:flex; justify-content: center; gap: 2px; align-content: center; align-items: center;">${value.replace(" Mukhi","M")}</span><span style="display: flex; justify-content: center; gap: 2px; align-content: center; align-items: center;">(<textarea class="gmsInput" value="" maxlength="5" style="font-size:9px!important; color:#000000!important; max-width:28px; margin-top:-1.5px;" type="text"></textarea> ${i==1? "mm" : "gms"})</span></div></div>`
